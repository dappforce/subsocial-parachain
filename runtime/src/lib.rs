...
struct SocialActionFilter;
impl Contains<Call> for SocialActionFilter {
    fn contains(c: &Call) -> bool {
        matches!(
            *c,
            Call::AccountFollows(..) |
...
pub struct EnergyCallFilter;
impl Contains<Call> for EnergyCallFilter {
    fn contains(c: &Call) -> bool {
        SocialActionFilter::contains(c) ||
            matches!(
                *c,
                Call::Domains(..) |
                Call::Energy(..),
...
impl pallet_energy::Config for Runtime {
    ...
    type ExistentialDeposit = ExistentialDeposit;
    type CallFilter = EnergyCallFilter;
