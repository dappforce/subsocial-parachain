//! Subsocial Kusama parachain variant runtime.
...
pub use subsocial_common as common;
use subsocial_common::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("kusocial"),
	impl_name: create_runtime_str!("kusocial"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
