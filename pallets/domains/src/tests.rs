...
use pallet_subsocial_support::mock_functions::{another_valid_content_ipfs, invalid_content_ipfs, valid_content_ipfs};
use pallet_subsocial_support::new_who_and_when;
...
fn set_domain_content_should_fail_when_content_is_invalid() {
    ExtBuilder::default().build_with_default_domain_registered().execute_with(|| {
        assert_noop!(
            ...
            DispatchError::Other(pallet_subsocial_support::Error::InvalidIpfsCid.into()),
        );
    });
}
