...
pub trait WeightInfo {
    fn set_space_follow_settings() -> Weight;
...
pub struct SubstrateWeight<T>(PhantomData<T>);
        impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
            ...
            // Storage: SpaceFollows FollowSettingsForSpace (r:0 w:1)
        fn set_space_follow_settings() -> Weight {
        (6_000_000 as Weight)
            ...
            // Storage: Spaces SpaceById (r:1 w:0)
            // Storage: SpaceFollows FollowSettingsForSpace (r:1 w:0)
            // Storage: SpaceFollows SpaceSubscribers (r:1 w:0)
